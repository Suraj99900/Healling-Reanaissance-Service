            ...
            <div class="card-body">
                <div class="max-w-lg mx-auto">
                    <div class="text-center">
                        <h1 class="text-3xl font-bold card-title center">Kvita's Healling Reanaissance OTP Verification</h1>
                        ...
                        <div class="grid grid-cols-6 gap-4">
                            <div class="col-span-1 text-center">
                                ...
                                class="text-center"
                                    ...
                                    value="{{$otp}}" maxlength="1" />
                            </div>
                        </div>
                        <div class="mt-8">
                            <h5 class="text-center text-gray-500" style="font-size: 12px;">{{$contact_details}}</h5>
