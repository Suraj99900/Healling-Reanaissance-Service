                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item mx-3">
                                <a href="{{ url('/') }}" class="nav-link bar-link {{ $iActive == '' ? 'active' : '' }}">
                            ...
                            @if ($bIsLogin)
                                ...
                                <li class="nav-item mx-3">
                                    <a id="logoutId" class="btnWAN btn-sm nav-link login mx-3">Log Out</a>
                                </li>
                            @else
                                <li class="nav-item mx-1">
                                    <a href="{{ url('login') }}" class="btnWAN btn-sm nav-link login">Login</a>
                                </li>
                                <li class="col">
                                    <a href="{{ url('register') }}" class="btnWAN nav-link register mx-3 mt-1">Register</a>
                                </li>
                            @endif
                        </ul>
                    </div>
