                ...
                <div class="card-black-transparent">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-12 img-box p-5">
                            <img src="{{asset("img/LifeHealer/user1.png")}}" class="img-fluid rounded" alt="Manifestation">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-transparent p-2 m-2">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 card-imag">
                            <img src="{{asset("img/LifeHealer/user2.jpg")}}" alt="मास्टरक्लास">
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="service-item padd-15">
                        <div class="service-item-inner">
                            <div class="icon img-box">
                                <img src="{{asset("img/LifeHealer/b_1.png")}}" alt="bonus 1" srcset="bonus 1">
                            </div>
                            <h4>BONUS 1</h4>
                    ...
                    <div class="service-item padd-15">
                        <div class="service-item-inner">
                            <div class="icon img-box">
                                <img src="{{asset("img/LifeHealer/b_2.png")}}" alt="bonus 1" srcset="bonus 1">
                            </div>
                            <h4>BONUS 2</h4>
                    ...
                    <div class="service-item padd-15">
                        <div class="service-item-inner">
                            <div class="icon img-box">
                                <img src="{{asset("img/LifeHealer/b_3.png")}}" alt="bonus 1" srcset="bonus 1">
                            </div>
                            <h4>BONUS 3</h4>
                    ...
                    <div class="card-black-transparent mb-5">
                        ...
                        <div class="row">
                            <div class="card-imag p-2">
                                <img src="{{asset("img/LifeHealer/feedBack_1.jpeg")}}" alt="">
                            </div>
                            <div class="card-imag p-2">
                                <img src="{{asset("img/LifeHealer/feedBack_2.jpeg")}}" alt="">
                            </div>
                            <div class="card-imag p-2">
                                <img src="{{asset('img/LifeHealer/feedBack_3.jpeg')}}" alt="">
                            </div>
                            <div class="card-imag p-2">
                                <img src="{{asset('img/LifeHealer/feedBack_4.jpeg')}}" alt="">
                            </div>
                            <div class="card-imag p-2">
                                <img src="{{asset('img/LifeHealer/feedBack_5.jpeg')}}" alt="">
                            </div>
                            <div class="card-imag p-2">
                                <img src="{{asset('img/LifeHealer/feedBack_6.jpeg')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="card-black-transparent">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="col-lg-12 col-md-12 col-sm-12 card-imag" style="width: 100% ;">
                                <img src="{{asset('img/LifeHealer/user3.jpg')}}" alt="मास्टरक्लास">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="Timer row flex justify-content-center">
...
@include('CDN_Footer')
<script>
    var eventYear = "{{ config('app.event.year') }}";
    var eventMonth = "{{ config('app.event.month') }}"; // Ensure it's zero-based for JS Date
    var eventDay = "{{ config('app.event.day') }}";
    var eventHour = "{{ config('app.event.hour') }}";
    var eventMinute = "{{ config('app.event.minute') }}";

    // JavaScript Date expects month in 0-11 format, subtract 1
    var countDownDate = new Date(eventYear, eventMonth - 1, eventDay, eventHour, eventMinute, 0).getTime();
